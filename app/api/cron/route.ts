    ...
    <body style="margin: 0; padding: 0; background-color: #f3f4f6; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
      ...
      <div style="${EMAIL_STYLES.container}">
        ...
        <div style="${EMAIL_STYLES.footer}">
          ...
          <span style="opacity: 0.7">This content is AI-curated. Verify sources before acting.</span>
        </div>
      </div>
      </center>
    </body>
...
async function runDigestJob() {
    ...
    const subjectLine = `Hajimi Daily #${today.toISOString().split('T')[0]}`;

    // Send in parallel to save time within timeout
